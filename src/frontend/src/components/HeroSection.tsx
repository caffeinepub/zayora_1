      ...
      <div className="container relative mx-auto px-4 py-20 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium">Premium Tech Products</span>
          </div>
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-orange-50 md:text-xl">
            Experience the future of audio and wearable technology with our premium Bluetooth earbuds and smartwatches
          </p>
